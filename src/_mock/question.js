...
export const question2 = {
    question: "<b>Cho mạch điện như hình vẽ</b><img src='https://minimals.cc/assets/images/avatars/avatar_5.jpg' />: Mỗi nguồn có $\\xi  = 4,5$V, Bình điện phân đựng dung dịch${\\rm{\\;CuS}}{{\\rm{O}}_4}/{\\rm{Cu}}$. Cho biết A = 64, n = 2.",
    choices: [
        {
            content: 'AAAA',
            isTrue: true
