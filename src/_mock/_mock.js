...
const _mock = {
  ...
  image: {
    cover: (index) => `https://minimals.cc/assets/images/covers/cover_${index + 1}.jpg`,
    feed: (index) => `https://minimals.cc/assets/images/feeds/feed_${index + 1}.jpg`,
    product: (index) => `https://minimals.cc/assets/images/products/product_${index + 1}.jpg`,
    avatar: (index) => `https://minimals.cc/assets/images/avatars/avatar_${index + 1}.jpg`,
  },
};
